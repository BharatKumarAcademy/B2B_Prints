package com.login2print.b2bprintz.Payments;
...
public class PaymentsApprovedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //connect layout
        setContentView(R.layout.activity_new_order_brochure);
