...
public class ordersIconsAdapter extends BaseAdapter {
    ...
    public ordersIconsAdapter(Context context) {
        mInflater = LayoutInflater.from(context);
        mContext  = context;
        iconImages  = context.getResources().getStringArray(R.array.orderIconsImages);
        activities  = context.getResources().getStringArray(R.array.orderIconsActivities);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch(i){
            case 0:
                Picasso.with(mContext).load(R.drawable.order_filepending_icon).into(picture);
                break;
            case 1:
                Picasso.with(mContext).load(R.drawable.order_paymentpending_icon).into(picture);
                break;
            case 2:
                Picasso.with(mContext).load(R.drawable.order_cancelled_icon).into(picture);
                break;
            case 3:
                Picasso.with(mContext).load(R.drawable.order_inprocess_icon).into(picture);
                break;
            case 4:
                Picasso.with(mContext).load(R.drawable.order_neworder_icon).into(picture);
                break;
            case 5:
                Picasso.with(mContext).load(R.drawable.order_delivered_icon).into(picture);
                break;
        }
