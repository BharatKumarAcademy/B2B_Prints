...
public class newOrderIconsAdapter extends BaseAdapter {
    ...
    public newOrderIconsAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch(i){
            case 0:
                Picasso.with(mContext).load(R.drawable.visitingcards_icon).into(picture);
                break;
            case 1:
                Picasso.with(mContext).load(R.drawable.envelopes_icon).into(picture);
                break;
            case 2:
                Picasso.with(mContext).load(R.drawable.pamphlets_icon).into(picture);
                break;
            case 3:
                Picasso.with(mContext).load(R.drawable.letterheads_icon).into(picture);
                break;
            case 4:
                Picasso.with(mContext).load(R.drawable.invitations_icon).into(picture);
                break;
            case 5:
                Picasso.with(mContext).load(R.drawable.brochure_icon).into(picture);
                break;
        }
