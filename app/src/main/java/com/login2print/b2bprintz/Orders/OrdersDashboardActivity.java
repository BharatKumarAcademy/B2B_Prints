...
import com.login2print.b2bprintz.Adapters.ordersIconsAdapter;
...
public class OrdersDashboardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* try {
        ...
        gridView.setAdapter(new ordersIconsAdapter(this));
    ...
    public void readyToDispatch(View v){
        Intent intent =  new Intent(this, OrdersReadyToDispatchActivity.class);
