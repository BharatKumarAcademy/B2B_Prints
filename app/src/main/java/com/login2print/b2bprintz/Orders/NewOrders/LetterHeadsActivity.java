package com.login2print.b2bprintz.Orders.NewOrders;
...
public class LetterHeadsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //connect layout
        setContentView(R.layout.activity_new_order_letter_heads);
